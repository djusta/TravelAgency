...
<body class="">
    ...
    <section class="bg-gray-700 py-12 bg-cover bg-blend-overlay"
        style="background-image: url('https://img.freepik.com/free-photo/landscape-morning-fog-mountains-with-hot-air-balloons-sunrise_335224-794.jpg?w=1060&t=st=1708099962~exp=1708100562~hmac=b518936367f62f78589342cfa766a93aaa000f1830e29ef7e8827ef4be4aef1f')">
                ...
                <form action="{{ route('landingPage.storeLead') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name"
                            class="text-black w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="message" name="message" rows="4"
                            class="text-black w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"></textarea>
                    </div>
                    <button type="submit"
                        class="bg-indigo-900 block mx-auto text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Submit</button>
                </form>
            </div>
        </div>
    </section>
    ...
    <section class="bg-indigo-500 text-neutral-100 py-16">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-3">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="white" id="Filled" viewBox="0 0 24 24"
                        class="h-16 mx-auto">
                        <path
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="white" id="Layer_1" data-name="Layer 1"
                        viewBox="0 0 24 24" class="h-16 mx-auto">
                        <path
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="white" id="Layer_1" data-name="Layer 1"
                        viewBox="0 0 24 24" class="w-16 mx-auto">
                        <path
                            d="M13.569,6l1.964,5H8.477l2-5Zm4.112,5h6.248a3.013,3.013,0,0,0-.476-.979L21.406,7.228A3.009,3.009,0,0,0,18.986,6H15.717Zm-2.067,2H8.386L12,23.879Zm2.108,0-2.743,8.255,8.167-7.332A3.045,3.045,0,0,0,23.78,13ZM6.278,13H.23a3.144,3.144,0,0,0,.661.957l8.13,7.3Zm.045-2,2-5H5.014a3.009,3.009,0,0,0-2.42,1.228L.547,10.021A3.01,3.01,0,0,0,.072,11ZM13,0H11V4h2Zm6.844,1.652L18.156.578l-2,3.142,1.688,1.074Zm-12,2.068-2-3.142L4.156,1.652l2,3.142Z" />
                    </svg>
